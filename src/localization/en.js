export default {
  ...
  auth: {
    ...
    error_account_exists_different_provider: 'An account already exists with this email using a different sign-in method. Please sign in with your email and password.',
    continue_with_apple: 'Sign in with Apple',
